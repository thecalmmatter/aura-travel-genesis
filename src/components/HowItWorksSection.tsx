...
const steps = [
  {
    ...
    description:
      "Tell us about your travel aspirations, preferences, and budget",
    step: "01",
  },
  {
    icon: Rocket,
    ...
    description:
      "Our specialized agents collaborate to craft your perfect journey",
    step: "02",
  },
  {
    icon: Calendar,
    ...
    description:
      "Fine-tune your itinerary with real-time suggestions and alternatives",
    step: "03",
  },
  {
    icon: Plane,
    title: "Travel & Enjoy",
    description:
      "Experience seamless travel with 24/7 AI support throughout your journey",
    step: "04",
  },
];
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            From dream to reality in four simple steps, powered by cutting-edge
            AI technology
          </p>
        </motion.div>
        ...
        <div className="relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              ...
              >
                <div className="backdrop-blur-xl bg-white/10 rounded-3xl border border-white/20 p-8 shadow-2xl hover:shadow-3xl transition-all duration-300 h-full flex flex-col justify-between">
                  {/* Step Number */}
        ...
        >
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-r from-pink-500 to-blue-500 hover:from-pink-600 hover:to-blue-600 text-white px-12 py-4 rounded-full text-lg font-semibold shadow-lg hover:shadow-2xl transition-all duration-300"
          >
            See How It Works
            <motion.span
              animate={{ x: [0, 5, 0] }}
